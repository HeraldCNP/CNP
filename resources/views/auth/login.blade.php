...
<head>
    ...
    <title>Colegio Nacional Pichincha | Login</title>
...
<body class="hold-transition login-page" style="background-image: url({{ asset('/images/font1.jpg') }});">
<div class="login-box">
    ...
    <div class="login-box-body">
        <img src="{{ asset('/images/logo_pichincha_oficial.png') }}" alt="" width="75px" style="display: block; margin: auto">
