        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto mr-auto text-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navcnp">
                        <a class="dropdown-item" href="#">Colegio</a>
                        <a class="dropdown-item" href="#">Banda</a>
                        <a class="dropdown-item" href="#">Ck´alcheños</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navcnp" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">+Pichincha</a>
                </li>
                <li class="nav-item">
...
<footer class="footer">
    <div class="container">
        <p><a class="text-white" href="#">Team TiC Pichincha</a> &copy; 2020 Todos los derechos reservados</p>
        <ul class="redes">
